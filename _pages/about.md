...
My research integrates urban planning knowledge, geospatial data, and deep generative models (e.g., diffusion models, GANs, and neural 3D representations) to study land-use configuration, POI-driven urban functions, population distribution, and 3D urban scenes.
...
Looking ahead, I plan to further develop planning-oriented multi-modal urban datasets and generative modeling frameworks that link urban design, land-use configuration, and spatial decision-making. I am actively seeking collaborators from AI, urban computing, geography, and planning who are interested in generative models, spatial reasoning, or real-world urban applications.
